...
export const authApi = {
  ...
  resendVerification: async (data: ResendVerificationInput): Promise<ApiResponse<void>> => {
  ...
  resetPassword: async (token: string, data: ResetPasswordInput): Promise<ApiResponse<void>> => {
